...
description: "LoCoMo and LongMemEval_S scores, with category tables, latency, tokens, and methodology."
icon: "trophy"
---
...
Tex scores **93.3%** overall on **LoCoMo** with the full system. Tex scores **92.2%** on **LongMemEval_S** with active retrieval only.
