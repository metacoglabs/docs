...
description: "Use Tex recall with Azure OpenAI chat completions."
icon: "cloud"
---

This recipe uses the same flow as the [FastAPI recipe](/recipes/fastapi). Recall memory, answer with Azure OpenAI, then store the new turn.
